...
const QRRequestItem: React.FC<{ title: string; address: string; date: string; status: string }> = ({ title, address, date, status }) => (
    <div className="py-4">
        <div className="flex items-start space-x-4">
            <img src={`https://api.qrserver.com/v1/create-qr-code/?size=50x50&data=${title}`} alt="QR small" className="rounded-md flex-shrink-0" />
            <div>
...
const ManageQRPage: React.FC = () => {
    ...
    const qrCodes = [
        { id: 'Q201946579', desc: 'All Marketing Sales-MS1903041155331648980231', terminal: 'Terminal 1' },
        { id: 'Q201946579', desc: 'All Marketing Sales-MS1903041155331648980231', terminal: 'Terminal 2' },
        { id: 'Q201946579', desc: 'All Marketing Sales-MS1903041155331648980231', terminal: 'Terminal 3' },
    ];
    ...
    return (
        ...
        <div className="font-sans bg-white p-6">
            <h1 className="text-2xl font-bold mb-6 text-gray-800">Manage QR/POS</h1>
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
                <div className="lg:col-span-2 bg-white p-8 rounded-2xl border border-gray-100 shadow-lg flex flex-col items-center text-center">
                    <img src={AppLogo} alt="Pay Business Logo" className="h-8 mb-6" />
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=UPI-ID-9876543210@qpay" alt="Main QR Code" className="rounded-lg" />
                    <div className="flex items-center space-x-2 mt-6">
                        <p className="font-semibold text-gray-700">UPI ID: 9876543210@qpay</p>
                        <button 
                ...
                <div className="lg:col-span-3 bg-white p-6 rounded-2xl border border-gray-100 shadow-lg">
